defmodule Painsnakes.AccountsTest do
  ...
  describe "register_team/1" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_team(%{email: "not valid", password: "not valid"})
    ...
    test "validates maximum values for email and password for security" do
      ...
      {:error, changeset} = Accounts.register_team(%{email: too_long, password: too_long})
    ...
    test "registers teams with a hashed password" do
      ...
      {:ok, team} = Accounts.register_team(valid_team_attributes(email: email))
  ...
  describe "change_team_registration/2" do
    test "returns a changeset" do
      ...
      assert changeset.required == [:password, :team_name, :email]
    end
    ...
    test "allows fields to be set" do
      ...
      changeset =
        Accounts.change_team_registration(
          %Team{},
          valid_team_attributes(email: email, password: password)
        )
